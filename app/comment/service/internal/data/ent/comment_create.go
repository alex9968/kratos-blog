...
func (cc *CommentCreate) SetCount(i int64) *CommentCreate {
	cc.mutation.SetCount(i)
	return cc
}

// SetPrice sets the "price" field.
func (cc *CommentCreate) SetPrice(i int64) *CommentCreate {
	cc.mutation.SetPrice(i)
	return cc
}

// SetImages sets the "images" field.
func (cc *CommentCreate) SetImages(b []biz.Image) *CommentCreate {
	cc.mutation.SetImages(b)
	return cc
}
