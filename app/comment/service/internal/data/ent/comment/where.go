...
func Count(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func Price(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func CountEQ(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCount), v))
	})
}
...
func CountNEQ(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func CountIn(vs ...int64) predicate.Comment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CountNotIn(vs ...int64) predicate.Comment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CountGT(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func CountGTE(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func CountLT(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func CountLTE(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func PriceEQ(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPrice), v))
	})
}
...
func PriceNEQ(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func PriceIn(vs ...int64) predicate.Comment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceNotIn(vs ...int64) predicate.Comment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceGT(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func PriceGTE(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func PriceLT(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
...
func PriceLTE(v int64) predicate.Comment {
	return predicate.Comment(func(s *sql.Selector) {
